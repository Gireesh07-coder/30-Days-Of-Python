...
# height1=int(input("Enter the height value:"))
# print("are of a traingle is:",(1/2*base*height1))
...
# print("Perimeter of a traingle is:",a+b+c)
...
slope=((10-2)/(6-2))
print("Slope of a traingle is:",slope)
